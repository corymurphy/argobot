...
func (m *ApplicationManagedResourcesResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ApplicationManagedResourcesResponse) validateItems(formats strfmt.Registry) error {
...
func (m *ApplicationManagedResourcesResponse) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ApplicationManagedResourcesResponse) UnmarshalBinary(b []byte) error {
	var res ApplicationManagedResourcesResponse
