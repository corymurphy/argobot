...
func (m *ProjectGlobalProjectsResponse) validateItems(formats strfmt.Registry) error {
...
func (m *ProjectGlobalProjectsResponse) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ProjectGlobalProjectsResponse) UnmarshalBinary(b []byte) error {
	var res ProjectGlobalProjectsResponse
