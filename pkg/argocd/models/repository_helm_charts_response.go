...
func (m *RepositoryHelmChartsResponse) validateItems(formats strfmt.Registry) error {
...
func (m *RepositoryHelmChartsResponse) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RepositoryHelmChartsResponse) UnmarshalBinary(b []byte) error {
	var res RepositoryHelmChartsResponse
