...
func (m *RepositoryRepoAppDetailsResponse) validatePlugin(formats strfmt.Registry) error {
...
func (m *RepositoryRepoAppDetailsResponse) contextValidatePlugin(ctx context.Context, formats strfmt.Registry) error {
