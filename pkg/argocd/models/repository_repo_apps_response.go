...
func (m *RepositoryRepoAppsResponse) validateItems(formats strfmt.Registry) error {
...
func (m *RepositoryRepoAppsResponse) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RepositoryRepoAppsResponse) UnmarshalBinary(b []byte) error {
	var res RepositoryRepoAppsResponse
