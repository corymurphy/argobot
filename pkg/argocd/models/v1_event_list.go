...
func (m *V1EventList) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1EventList) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
