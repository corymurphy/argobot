...
// V1alpha1ApplicationList ApplicationList is list of Application resources
...
func (m *V1alpha1ApplicationList) validateItems(formats strfmt.Registry) error {
...
func (m *V1alpha1ApplicationList) validateMetadata(formats strfmt.Registry) error {
...
func (m *V1alpha1ApplicationList) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1alpha1ApplicationList) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1alpha1ApplicationList) UnmarshalBinary(b []byte) error {
	var res V1alpha1ApplicationList
