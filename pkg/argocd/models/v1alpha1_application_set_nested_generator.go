...
func (m *V1alpha1ApplicationSetNestedGenerator) validatePlugin(formats strfmt.Registry) error {
...
func (m *V1alpha1ApplicationSetNestedGenerator) contextValidatePlugin(ctx context.Context, formats strfmt.Registry) error {
