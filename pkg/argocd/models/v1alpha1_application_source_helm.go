...
func (m *V1alpha1ApplicationSourceHelm) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateValuesObject(formats); err != nil {
		res = append(res, err)
	}
...
func (m *V1alpha1ApplicationSourceHelm) validateValuesObject(formats strfmt.Registry) error {
	if swag.IsZero(m.ValuesObject) { // not required
		return nil
	}

	if m.ValuesObject != nil {
		if err := m.ValuesObject.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("valuesObject")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("valuesObject")
			}
			return err
		}
	}
...
func (m *V1alpha1ApplicationSourceHelm) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateValuesObject(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *V1alpha1ApplicationSourceHelm) contextValidateValuesObject(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.ValuesObject != nil {
		...
		if err := m.ValuesObject.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("valuesObject")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("valuesObject")
