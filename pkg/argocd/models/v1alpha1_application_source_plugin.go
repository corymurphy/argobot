...
type V1alpha1ApplicationSourcePlugin struct {
	...
	// parameters
	Parameters []*V1alpha1ApplicationSourcePluginParameter `json:"parameters"`
}
...
func (m *V1alpha1ApplicationSourcePlugin) validateParameters(formats strfmt.Registry) error {
...
func (m *V1alpha1ApplicationSourcePlugin) contextValidateParameters(ctx context.Context, formats strfmt.Registry) error {
