...
func (m *V1alpha1ApplicationSpec) validateSources(formats strfmt.Registry) error {
...
func (m *V1alpha1ApplicationSpec) contextValidateSources(ctx context.Context, formats strfmt.Registry) error {
