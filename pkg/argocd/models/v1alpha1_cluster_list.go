...
func (m *V1alpha1ClusterList) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1alpha1ClusterList) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
