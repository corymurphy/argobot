...
func (m *V1alpha1ConfigManagementPlugin) contextValidateGenerate(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1alpha1ConfigManagementPlugin) contextValidateInit(ctx context.Context, formats strfmt.Registry) error {
