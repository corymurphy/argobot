...
func (m *V1alpha1JWTTokens) validateItems(formats strfmt.Registry) error {
...
func (m *V1alpha1JWTTokens) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
