...
type V1alpha1PullRequestGenerator struct {
	...
	// azuredevops
	Azuredevops *V1alpha1PullRequestGeneratorAzureDevOps `json:"azuredevops,omitempty"`

	// bitbucket
	Bitbucket *V1alpha1PullRequestGeneratorBitbucket `json:"bitbucket,omitempty"`
...
func (m *V1alpha1PullRequestGenerator) validateAzuredevops(formats strfmt.Registry) error {
...
func (m *V1alpha1PullRequestGenerator) validateBitbucket(formats strfmt.Registry) error {
...
func (m *V1alpha1PullRequestGenerator) contextValidateAzuredevops(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1alpha1PullRequestGenerator) contextValidateBitbucket(ctx context.Context, formats strfmt.Registry) error {
