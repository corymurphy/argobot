...
func (m *V1alpha1RepositoryCertificateList) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1alpha1RepositoryCertificateList) validateItems(formats strfmt.Registry) error {
...
func (m *V1alpha1RepositoryCertificateList) validateMetadata(formats strfmt.Registry) error {
...
func (m *V1alpha1RepositoryCertificateList) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1alpha1RepositoryCertificateList) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1alpha1RepositoryCertificateList) UnmarshalBinary(b []byte) error {
	var res V1alpha1RepositoryCertificateList
