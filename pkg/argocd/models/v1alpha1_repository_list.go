...
func (m *V1alpha1RepositoryList) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1alpha1RepositoryList) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
