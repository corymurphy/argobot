...
type V1alpha1ResourceOverride struct {
	...
	IgnoreResourceUpdates *V1alpha1OverrideIgnoreDiff `json:"ignoreResourceUpdates,omitempty"`
...
func (m *V1alpha1ResourceOverride) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateIgnoreResourceUpdates(formats); err != nil {
		res = append(res, err)
	}
...
func (m *V1alpha1ResourceOverride) validateIgnoreResourceUpdates(formats strfmt.Registry) error {
	if swag.IsZero(m.IgnoreResourceUpdates) { // not required
		return nil
	}

	if m.IgnoreResourceUpdates != nil {
		if err := m.IgnoreResourceUpdates.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("ignoreResourceUpdates")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("ignoreResourceUpdates")
			}
			return err
		}
	}
...
func (m *V1alpha1ResourceOverride) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateIgnoreResourceUpdates(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *V1alpha1ResourceOverride) contextValidateIgnoreResourceUpdates(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.IgnoreResourceUpdates != nil {
		...
		if err := m.IgnoreResourceUpdates.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("ignoreResourceUpdates")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("ignoreResourceUpdates")
