...
func (m *V1alpha1SyncOperation) validateSources(formats strfmt.Registry) error {
...
func (m *V1alpha1SyncOperation) contextValidateSources(ctx context.Context, formats strfmt.Registry) error {
