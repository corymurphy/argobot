	...
	if m.SyncStrategyApply != nil {
		if err := m.SyncStrategyApply.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("syncStrategyApply")
			}
			return err
		}
	}
...
func (m *V1alpha1SyncStrategyHook) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateSyncStrategyApply(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *V1alpha1SyncStrategyHook) contextValidateSyncStrategyApply(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.SyncStrategyApply != nil {
		...
		if err := m.SyncStrategyApply.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("syncStrategyApply")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("syncStrategyApply")
